...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    NSURL *url = [NSURL URLWithString:@"lxfapp:"];
    
    [[UIApplication sharedApplication] openURL:url];
//    UIStoryboard *story = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
//    UIViewController *vc = [story instantiateViewControllerWithIdentifier:@"main"];
//    UIImageView *im = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 320, 200)];
//    [im setImage:[UIImage imageNamed:@"雪花"]];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "lxf.____" in the application's documents directory.
